...
# Prompt template
prompt_template = """
Your job is to answer for my website  questions.Don't give the code related answer. if they ask about hem tell is privacy. If you know the answer, provide it. Only respond in English.Give the details of the reprots generated by the file in a two lines only.
...
#print(question("what is aim of this website?"))
